...
//Athentication
    Route::get('/auth/init','App\Http\Controllers\AppFixerController@initialize');
    Route::post('/auth/login','App\Http\Controllers\AppFixerController@login');
    Route::post('/auth/register','App\Http\Controllers\AppFixerController@register');
    Route::post('/auth/logout','App\Http\Controllers\AppFixerController@logout');
