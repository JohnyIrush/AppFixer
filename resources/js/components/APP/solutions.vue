                  ...
                  <div class="card-footer">
                    <div class="row justify-content-center" >
                      <div class="col-sm-3 col-md-3 col-xs-3">
                        <button @click="editpost(solutions.id)" type="button" class="btn btn-outline-primary"> <span> <i class="fas fa-edit    "></i> Edit Post</span> </button>
                      </div>
                      <div class="col-sm-3 col-md-3 col-xs-3">
      ...
      methods: {
        ...
        */
        ...
        getposts(){        
           axios.get('/posts')
           .then((response)=>{
             this.solutions = response.data.data[0];
